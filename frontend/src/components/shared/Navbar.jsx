    ...
    return (
        <div className='bg-white border-b border-gray-200 shadow-sm sticky top-0 z-50 relative'>
            <div className='flex items-center justify-between mx-auto max-w-7xl px-4 h-16'>
                <div>
                    <Link to="/">
                        <h1 className='text-2xl font-bold cursor-pointer'>Job<span className='text-[#6A38C2]'>Ease</span></h1>
                    </Link>
                </div>
                            ...
                            <div className='flex items-center gap-2 md:gap-3 flex-shrink-0'>
                                <Link to="/login" className="flex-shrink-0">
                                    <Button 
                                        variant="outline" 
                                        size="default"
                                        className="border-2 border-[#6A38C2] text-[#6A38C2] hover:bg-[#6A38C2] hover:text-white transition-all duration-300 font-semibold px-4 md:px-6 whitespace-nowrap"
                                    >
                                        Login
                                    </Button>
                                </Link>
                                <Link to="/signup" className="flex-shrink-0">
                                    <Button 
                                        size="default"
                                        className="bg-[#6A38C2] hover:bg-[#5b30a6] text-white font-semibold shadow-md hover:shadow-lg transition-all duration-300 px-4 md:px-6 whitespace-nowrap"
                                    >
                                        Sign Up
                                    </Button>
                                </Link>
